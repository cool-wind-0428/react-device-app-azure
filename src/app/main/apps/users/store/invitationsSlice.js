...
export const getUser = createAsyncThunk('usersApp/users/getUser', async params => {
	const response = await axios.get('/api/invitations-app/user', { params });
...
export const getUsers = createAsyncThunk('usersApp/users/getUsers', async () => {
	const response = await axios.get('/api/invitations-app/users');
	const data = await response.data;
...
export const saveUser = createAsyncThunk('usersApp/users/saveUser', async ( form, { dispatch, getState } ) => {
	const response = await axios.post('/api/invitations-app/user/save', form);
	const data = await response.data;
	console.log(data);
...
export const updateUser = createAsyncThunk('usersApp/users/updateUser', async ( {form, routeParams}, { dispatch, getState } ) => {
	const response = await axios.post('/api/invitations-app/user/update', form);
	const data = await response.data;
	console.log(data);
...
export const removeUsers = createAsyncThunk('usersApp/users/removeUsers', async (ids, { dispatch, getState }) => {
	const response = await axios.post('/api/invitations-app/remove-users', { ids });
	const data = await response.data;
	console.log(data);
